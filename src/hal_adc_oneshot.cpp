// external/idf_hals/src/hal_adc_oneshot.cpp
...
esp_err_t HalAdcOneshot::read(adc_oneshot_unit_handle_t handle, adc_channel_t channel, int *chan_raw) {
    return ::adc_oneshot_read(handle, channel, chan_raw);
}
...
esp_err_t HalAdcOneshot::io_to_channel(int io_num, adc_unit_t *const unit_id, adc_channel_t *const channel) {
