// external/idf_hals/include/interfaces/i_hal_adc_oneshot.hpp
#pragma once
...
public:
    ...
    virtual esp_err_t read(adc_oneshot_unit_handle_t handle, adc_channel_t channel, int *chan_raw) = 0;
    ...
    virtual esp_err_t io_to_channel(int io_num, adc_unit_t *const unit_id, adc_channel_t *const channel) = 0;
};
