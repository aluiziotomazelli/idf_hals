// external/idf_hals/include/interfaces/i_hal_adc_calibration.hpp
#pragma once
...
public:
    ...
    /** @brief Create a calibration scheme tailored to the target hardware (Line or Curve fitting) */
    virtual esp_err_t create_scheme(adc_unit_t unit_id, adc_channel_t chan, adc_atten_t atten, adc_bitwidth_t bitwidth, adc_cali_handle_t *ret_handle) = 0;

    /** @brief Delete the calibration scheme */
    virtual esp_err_t delete_scheme(adc_cali_handle_t handle) = 0;
