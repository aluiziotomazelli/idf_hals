// external/idf_hals/include/hal_adc_oneshot.hpp
#pragma once
...
public:
    ...
    esp_err_t read(adc_oneshot_unit_handle_t handle, adc_channel_t channel, int *chan_raw) override;
    ...
    esp_err_t io_to_channel(int io_num, adc_unit_t *const unit_id, adc_channel_t *const channel) override;
};
